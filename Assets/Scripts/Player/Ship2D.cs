...
/* Author: Jonas Iacobi (12:16 23-10-2017)
...
public class Ship2D : MonoBehaviour {
	...
	public float integrity;										//The ship's maxímum health, i.e. how much damage it can withstand. Translates to the player's maximum hp
